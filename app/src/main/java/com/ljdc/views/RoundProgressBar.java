...
public class RoundProgressBar extends View {
    ...
    public RoundProgressBar(Context context, AttributeSet attrs) {
        ...
        mBorderWidth = mTypedArray.getDimension(R.styleable.RoundProgressBar_barBorderWidth, getResources().getDimensionPixelSize(R.dimen.round_progress_border_width));
